...
export function Sidebar() {
  ...
  const { role, staffData, user, signOut } = useAuth();
    ...
    <aside className="hidden md:flex w-64 flex-col bg-slate-950 border-r border-slate-800 h-screen shrink-0">
      ...
      <div className="p-4 border-t border-slate-800 text-xs">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-full bg-indigo-600 border border-indigo-400/30 flex items-center justify-center text-white font-bold text-xs uppercase shrink-0">
